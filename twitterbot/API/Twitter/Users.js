...
export function getTweetsFromUser(id){
    var myHeaders = new Headers();
    myHeaders.append("Authorization", "OAuth oauth_consumer_key=\"QZEtRk1FreVFoOcjX7xFTP77I\",oauth_token=\"1300498070-HiIP7UIJp8gNFBJmqzYkc44T4Ks9aeDRHyjoe49\",oauth_signature_method=\"HMAC-SHA1\",oauth_timestamp=\"1589969327\",oauth_nonce=\"CG92RCrOHS0\",oauth_version=\"1.0\",oauth_signature=\"LravNamsxtH87IkDwpP840pMWxc%3D\"");
    myHeaders.append("Cookie", "personalization_id=\"v1_+Id0xPt1JkhQPN9KEkKUjw==\"; guest_id=v1%3A158996705689084687; lang=fr");
